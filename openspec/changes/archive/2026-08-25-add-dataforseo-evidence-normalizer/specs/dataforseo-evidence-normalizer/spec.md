...
- **THEN** normalization checks recognition and duplicated provenance consistency but does not rerun complete response-schema or metric-field validation
