...
Provide one shared, policy-neutral Evidence and Source representation with constrained values, deterministic JSON boundaries, and ID-based downstream references.
